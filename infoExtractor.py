# -*- coding: utf-8 -*-
"""
Created on Wed Jul 14 06:29:34 2021
...
class InfoExtractor:
    ...
    def extractFromFile(self, filename):
        doc, text = utils.loadDocumentIntoSpacy(filename, self.parser, self.nlp)
    ...
    @staticmethod
    def findWorkAndEducation(categories, doc, text, name):
    ...
    @staticmethod
    def getNumberOfMonths(datepair):
        """
    ...
    @staticmethod
    def getTotalExperience(experience_list):
        """
    ...
    @staticmethod
    def getTotalExperienceFormatted(exp_list):
...
if __name__ == "__main__":
    ...
    nlp = utils.loadDefaultNLP(is_big=False)
